...
export const SignUp = () => {
  ...
  const signupReq = async (e) => {
    try {
      ...
      let res = await fetch("https://brand-and-beyond.herokuapp.com/signup", {
        method: "POST",
        headers: {
  ...
  return (
    <div style={{display:'flex',flexDirection:'row'}}>
      ...
      <Typography sx={{textAlign:'center', fontSize:34}}>Sign Up to Brand And Beyond It</Typography>
      <Typography sx={{textAlign:'center', fontSize:20 ,color:'#B3B3B3', marginBottom:'8%'}}>Enter Your Credentials</Typography>
      <Box component="form">
        <Grid container spacing={5}>
        <Grid item xs={12} sm={12} sx={{display:'flex' ,justifyContent:'center'}}>
        <AccountCircleIcon sx={{marginRight:"6%",marginTop:"5%"}}/>
            <TextField
              required
              fullWidth
              id="name"
          ...
          <Grid item xs={12} sm={12} sx={{display:'flex' ,justifyContent:'center'}}>
            ...
            <EmailIcon sx={{marginRight:"6%",marginTop:"5%"}}/>
            <TextField
              required
              fullWidth
              id="Email"
          ...
          <Grid item xs={12} sm={12} sx={{display:'flex' ,justifyContent:'center'}}>
          <HttpsIcon sx={{marginRight:"6%",marginTop:"5%"}}/>
            <TextField
              required
              fullWidth
              id="name"
